...
pkgdatadir = $(datadir)/apertium-sah
pkgincludedir = $(includedir)/apertium-sah
pkglibdir = $(libdir)/apertium-sah
pkglibexecdir = $(libexecdir)/apertium-sah
...
CONFIG_CLEAN_FILES = apertium-sah.pc
...
am__installdirs = "$(DESTDIR)$(apertium_sahdir)" \
	"$(DESTDIR)$(pkgconfigdir)"
DATA = $(apertium_sah_DATA) $(noinst_DATA) $(pkgconfig_DATA)
am__tagged_files = $(HEADERS) $(SOURCES) $(TAGS_FILES) $(LISP)
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/apertium-sah.pc.in \
...
ACLOCAL = ${SHELL} /Users/varie/Documents/apertium/apertium-sah/missing aclocal-1.15
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /Users/varie/Documents/apertium/apertium-sah/missing autoconf
AUTOHEADER = ${SHELL} /Users/varie/Documents/apertium/apertium-sah/missing autoheader
AUTOMAKE = ${SHELL} /Users/varie/Documents/apertium/apertium-sah/missing automake-1.15
AWK = gawk
CGCOMP = /usr/local/bin/cg-comp
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"apertium-sah\" -DPACKAGE_TARNAME=\"apertium-sah\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"apertium-sah\ 0.1.0\" -DPACKAGE_BUGREPORT=\"francis.tyers@uit.no\" -DPACKAGE_URL=\"\"
ECHO_C = \c
ECHO_N = 
ECHO_T = 
...
HFSTOSPELL_CFLAGS = 
HFSTOSPELL_LIBS = 
HFSTTWOL = /usr/local/bin/hfst-twolc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/varie/Documents/apertium/apertium-sah/missing makeinfo
MKDIR_P = ./install-sh -c -d
PACKAGE = apertium-sah
PACKAGE_BUGREPORT = francis.tyers@uit.no
PACKAGE_NAME = apertium-sah
PACKAGE_STRING = apertium-sah 0.1.0
PACKAGE_TARNAME = apertium-sah
PACKAGE_URL = 
...
STRIP = 
VERSION = 0.1.0
abs_builddir = /Users/varie/Documents/apertium/apertium-sah
abs_srcdir = /Users/varie/Documents/apertium/apertium-sah
abs_top_builddir = /Users/varie/Documents/apertium/apertium-sah
abs_top_srcdir = /Users/varie/Documents/apertium/apertium-sah
am__leading_dot = .
...
install_sh = ${SHELL} /Users/varie/Documents/apertium/apertium-sah/install-sh
...
TARGETS_COMMON = $(LANG1).automorf.hfst $(LANG1).autogen.hfst \
	$(LANG1).automorf.bin $(LANG1).autopgen.bin $(LANG1).autogen.bin \
...
###############################################################################
#
#   apertium_sah_dir: This is where the compiled binaries go
#   apertium_sah_srcdir: This is where the source files go
apertium_sahdir = $(prefix)/share/apertium/$(BASENAME)/
apertium_sah_srcdir = $(prefix)/share/apertium/$(BASENAME)/
EXTRA_TARGETS = $(am__append_1)
apertium_sah_DATA = $(TARGETS_COMMON) $(EXTRA_TARGETS)
...
$(am__aclocal_m4_deps):
apertium-sah.pc: $(top_builddir)/config.status $(srcdir)/apertium-sah.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
install-apertium_sahDATA: $(apertium_sah_DATA)
	@$(NORMAL_INSTALL)
	@list='$(apertium_sah_DATA)'; test -n "$(apertium_sahdir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(apertium_sahdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(apertium_sahdir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(apertium_sahdir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(apertium_sahdir)" || exit $$?; \
	done

uninstall-apertium_sahDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(apertium_sah_DATA)'; test -n "$(apertium_sahdir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(apertium_sahdir)'; $(am__uninstall_files_from_dir)
...
installdirs:
	for dir in "$(DESTDIR)$(apertium_sahdir)" "$(DESTDIR)$(pkgconfigdir)"; do \
...
install-data-am: install-apertium_sahDATA install-data-local \
...
uninstall-am: uninstall-apertium_sahDATA uninstall-pkgconfigDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-apertium_sahDATA install-data \
	...
	uninstall-am uninstall-apertium_sahDATA \
	uninstall-pkgconfigDATA
...
install-data-local: install-modes
	test -d $(DESTDIR)$(apertium_sah_srcdir) || mkdir -p $(DESTDIR)$(apertium_sah_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).lexc $(DESTDIR)$(apertium_sah_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).twol $(DESTDIR)$(apertium_sah_srcdir)
	$(INSTALL_DATA) $(BASENAME).$(LANG1).rlx $(DESTDIR)$(apertium_sah_srcdir)
	$(INSTALL_DATA) $(BASENAME).post-$(LANG1).dix $(DESTDIR)$(apertium_sah_srcdir)
clean-local:
	-rm -rf .deps modes
...
test: all
	echo "TODO test sentence" | apertium -d . sah-morph | tee .test-mt
